// SFNN without PSQT 1536 V2 architecture (rshogi/nnue-pytorch compatible)
//
// V1 (sfnnwop-1536.h) との差異:
// - FT ReadParameters: scale_weights/permute_weightsなし、標準LEB128読み込み
// - Transform: One=127 (rshogi互換、max output=31)
// - FV_SCALE: ヘッダの arch 文字列から自動検出

#ifndef CLASSIC_NNUE_SFNNWOP_1536_V2_H_INCLUDED
#define CLASSIC_NNUE_SFNNWOP_1536_V2_H_INCLUDED
...
#endif // CLASSIC_NNUE_SFNNWOP_1536_V2_H_INCLUDED
